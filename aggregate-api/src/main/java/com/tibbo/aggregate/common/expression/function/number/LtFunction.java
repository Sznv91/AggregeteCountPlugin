...
public class LtFunction extends AbstractFunction
{
  public LtFunction()
  {
    super("lt", Function.GROUP_NUMBER_PROCESSING, "Long number1, Long number2", "Boolean", Cres.get().getString("fDescLt"));
  }
