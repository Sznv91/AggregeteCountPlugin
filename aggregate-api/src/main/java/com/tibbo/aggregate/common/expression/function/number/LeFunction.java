...
public class LeFunction extends AbstractFunction
{
  public LeFunction()
  {
    super("le", Function.GROUP_NUMBER_PROCESSING, "Long number1, Long number2", "Boolean", Cres.get().getString("fDescLe"));
  }
